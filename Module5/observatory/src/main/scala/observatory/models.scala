...
case class StationSchema(stnID: String, wbanID: String, latitude: Double, longitude: Double)

case class TemperatureSchema(stnID: String, wbanID: String, month: Int, day: Int, temperature: Double)
